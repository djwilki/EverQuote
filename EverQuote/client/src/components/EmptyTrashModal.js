...
const EmptyTrashModal = () => {
    ...
    return (
        <div style={{position: 'fixed', width: '100%', height: '100%', backgroundColor: 'rgba(133, 133, 133, 0.5)', zIndex: '9', margin: '0', padding: '0', boxSizing: 'border-box'}}>
            <div style={{opacity: '1', transform: 'scale(1)', transition: 'transform 200ms 100ms ease,opacity 200ms 100ms ease', willChange: 'transform', border: '1px solid #ccc', color: '#333', minWidth: '465px', minHeight: '200px', maxWidth: '990px', background: '#fff', display: 'flex', justifyContent: 'center', flexDirection: 'column', boxShadow: '0 0 0 1px rgba(0,0,0,0.08),0 2px 15px rgba(0,0,0,0.2)', borderRadius: '4px'}}>
                <div>
