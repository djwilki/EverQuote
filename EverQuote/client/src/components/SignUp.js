      ...
      <div className={`${styles.form_wrapper} ${styles.centered}`}>
        <div className={styles.form_container}>
          <div className={styles.form_header}>
            <img
              alt="logo"
              src="https://i.imgur.com/GOpcw1D.png"
              style={{ width: '30%' }}
            />
            <h1 className={styles.header_title}>EverQuote</h1>
            <div className={styles.header_tagline}>
              Remember everything important.
            </div>
          </div>
          <button onClick={demoUserClick} className={styles.demo_button}>
          ...
          <div className={styles.form_footer}>
            ...
            <div className={styles.footer_cta_wrapper}>
              <Link className={styles.footer_cta} to="/login">
                Sign in
              </Link>
            </div>
          </div>
